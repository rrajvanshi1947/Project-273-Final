...
let LoginForm = props => {
    ...
    return (
        <form  onSubmit={handleSubmit} className="nav navbar-nav navbar-right form-inline" style={{marginTop:"10px"}}>           
        ...
        <button type="submit" className="btn btn-default logbutton" style={{marginLeft:"20px",background:'transparent',color:'white'}}>Sign In</button>
